...
secret: hidden javascript code executed before user code. does not share user code's scope. you can use this to draw on a second canvas (js string)
test: (object)
  setup: hidden javascript code executed before user code. shared with user scope. use to override functions or add a "global" variable for the user (js string)
